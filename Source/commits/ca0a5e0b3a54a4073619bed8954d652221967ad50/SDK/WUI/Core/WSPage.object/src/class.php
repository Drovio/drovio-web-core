 ...
 * @revised	December 30, 2014, 14:03 (EET)
 */
class WSPage extends HTMLPagePrototype
{
	...
	public function build($pagePath = "")
	{
		...
		// Set Head Content
		$this->setHead("FOLLOW, NOODP, NOYDIR");
	...
	private function addResources($pagePath)
	{
		...
		$this->addScript(url::resource("/js/q/jq.jquery.js"));
		$this->addScript(url::resource("/js/q/jq.jquery.easing.js"));
		$this->addScript(url::resource("/js/q/jq.jquery.ba-dotimeout.min.js"));
		
		// Add Web Core SDK Package Resources
		$sourceMap = new sourceMap(systemRoot.wsdkRoot);
