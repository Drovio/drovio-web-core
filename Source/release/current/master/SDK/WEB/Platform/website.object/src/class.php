 ...
 * @updated	September 20, 2015, 12:32 (EEST)
 */
class website
{
	/**
	...
	private function importPackage($library, $package)
	{
		...
		$packageTesterStatus = importer::getTesterStatus($library, $package);
		...
		foreach ($objects as $object)
		{
			...
			if (importer::onDevelopment())
				$nspath = websiteRoot."/src/".$library."/".$package."/".str_replace("::", "/", $objectName).innerClassPath;
			else
				$nspath = importer::getReleaseObjectPath($library, $package, $objectName);
