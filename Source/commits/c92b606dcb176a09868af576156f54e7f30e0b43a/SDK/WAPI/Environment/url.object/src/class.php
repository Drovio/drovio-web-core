 ...
 * @updated	May 29, 2015, 12:58 (EEST)
 */
class url
{
	/**
	 ...
	 * 		The resolved url.
	 */
	public static function resolve($sub, $url = "/", $params = array(), $protocol = NULL)
	{
	...
	public static function info($url = "", $domain = "")
	{
		...
		if (empty($domain) && $parts[0] != "www" && count($parts) < 3)
			$domain = $parts[0];
