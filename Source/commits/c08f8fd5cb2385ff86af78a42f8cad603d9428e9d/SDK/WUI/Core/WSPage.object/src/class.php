 ...
 * @updated	May 29, 2015, 10:32 (EEST)
 */
class WSPage extends HTMLPagePrototype
{
	...
	private function addResources($pagePath)
	{
		...
		$this->addScript("//cdn.redback.io/js/jquery/jquery-1.7.2.min.js");
		$this->addScript("//cdn.redback.io/js/jquery/plugins/jquery.easing-1.3.js");
		$this->addScript("//cdn.redback.io/js/jquery/plugins/jquery.ba-dotimeout-1.0.min.js");
		
		// Add reset css
		$this->addStyle("//cdn.redback.io/css/reset.css");
		...
		foreach ($libraries as $library)
		{
			...
			foreach ($packages as $package)
			{
				...
				$cssResource = "/css/".$resourceID.".css";
